          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              ...
              <p>
                ...
                commodo quis, gravida id, est. Sed lectus. <br /> Praesent elementum
            ...
            <div className="row">
              <div className="col-lg-5 mb-3 mb-lg-0">
                ...
                <p className="lead text-primary mb-3">
                  {"{"}" "{"}"}
                  Pellentesque odio nisi, euismod pharetra a ultricies <br /> in diam. Sed
                  arcu. Cras consequat{"{"}" "{"}"}
                </p>
                <p className="mb-2">
                  {"{"}" "{"}"}
                  ...
                  ante et vulputate volutpat, uctus metus libero eu augue.
                  {"{"}" "{"}"}
                </p>
              </div>
            ...
            <div className="col-lg-5">
              <div className="brands-text">
                ...
                <p>
                  ...
                  aliquet vel, dapibus id, mattis vel, nis
                </p>
              </div>
            </div>
