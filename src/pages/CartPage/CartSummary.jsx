...
const CartSummary = ({ subTotal, total, typeShip, handleUpdateShipping }) => {
  ...
  return (
    <aside className="col-lg-3">
      <div className="summary summary-cart">
        ...
        <table className="table table-summary">
          <tbody>
            ...
            <RadioGroup onChange={handleUpdateShipping} defaultValue={typeShip || ""}>
              {SHIPPING_OPTIONS.map((option) => {
                const { label, value, price } = option || {};
                return (
                  <tr className="summary-shipping-row" key={option.value}>
                    <td>
      ...
      <Link to={PATHS.PRODUCT} className="btn btn-outline-dark-2 btn-block mb-3">
