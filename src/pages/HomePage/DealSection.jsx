        ...
        <div className="row">
            ...
            <div className="deal" style={{ backgroundImage: 'url("assets/images/demos/demo-3/deal/bg-1.jpg")' }}>
              ...
              <div className="deal-content">
                <h3 className="product-title">
                  <Link to={PATHS.PRODUCT + `/${dealOfTheDayProduct.slug}`}>{dealOfTheDayProduct.name}</Link>
                </h3>
                ...
                <Link to={PATHS.PRODUCT + `/${dealOfTheDayProduct.slug}`} className="btn btn-link">
                  <span>Shop Now</span>
          ...
          <div className="col-lg-6">
            <div className="products">
              <div className="row">
                <div className="col-6">{dealProducts?.[1] && <ProductCard product={dealProducts[1]} />}</div>
                <div className="col-6">{dealProducts?.[2] && <ProductCard product={dealProducts[2]} />}</div>
              </div>
            </div>
          </div>
        </div>
        <div className="more-container text-center mt-3 mb-0">
          <Link to={PATHS.PRODUCT} className="btn btn-outline-dark-2 btn-round btn-more">
            <span>Shop more</span>
            <i className="icon-long-arrow-right" />
          </Link>
        </div>
